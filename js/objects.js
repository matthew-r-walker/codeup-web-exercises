(function() {
    ...
    me.sayHello = function () {
        return "Hello from " + me.firstName + " " + me.lastName;
    }
    ...
    function canHasDiscount(input) {
        if(input.amount > 200) {
            return " They're spending more than $200 they get a 12% discount. Their new total is $" + (input.amount - (input.amount * .12)).toFixed(2);
        } else {
            return " They do not qualify for a discount.";
        }
    }
